...
public class CQL2CSV extends AbstractMapper{
    ...
    protected void printVersion() {
        System.out.println("cqlTocsv version " + Consts.VERSION);
        System.exit(0);
    }
    ...
    protected  void printHelp(Options options) {
        ...
        String cmdLineSyntax =
                "cqlTocsv [-c contactpoint] [-q query] [FILE]";
    ...
    protected String map(Row row) {
        ...
        try {
            CSVPrinter csvPrinter = new CSVPrinter(stringBuffer, csvFormat.withDelimiter('\u0001').withNullString("\\N"));
